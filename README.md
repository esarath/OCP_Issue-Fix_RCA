...
| [30](issues/30-app-db-backup-dr-planning/) | App/DB Backup-Restore (Velero/OADP) & Multi-Region DR Planning | 2026-09-23 | N/A (Architecture/DR Design) | Documented — OADP install + nodeAgent fs-backup (NFS-compatible), DB logical dumps, enterprise backup options, active-passive/active-active DR decision matrix, restore-drill procedure; ready for execution |
